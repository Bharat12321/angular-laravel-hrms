...
import { GenderWidgetModule } from './gender-widget/gender-widget.module';
import { NationalityWidgetModule } from './nationality-widget/nationality-widget.module';
...
@NgModule({
  imports: [
    ...
    FlexLayoutModule,
    MatProgressSpinnerModule,GenderWidgetModule,NationalityWidgetModule,
