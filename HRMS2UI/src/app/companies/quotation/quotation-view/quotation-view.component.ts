...
export class QuotationViewComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public defaults: any,
              private dialogRef: MatDialogRef<QuotationViewComponent>,
  ...
  ngOnInit() {
    ...
    var quotationId=this.defaults;
      this.service.get('/invoice/'+quotationId).subscribe(data => {  
        this.data = data;
      });
  }
  print(): void {
